...
class InvoiceController extends Controller
{
    ...
    public function index()
    {
        if(\Auth::user()->level == "AdminUtama"){
            ...
            return view("app.invoice.adminutama.index", $d);
        }
        else{
            $d['checkouts'] = Checkout::where("user_id", \Auth::user()->id)->orderBy("id", "DESC")->get();
            return view("app.invoice.kasir.index", $d);
        }
    }
    ...
    public function show($id)
    {
        if(\Auth::user()->level == "AdminUtama"){
            ...
            return view("app.invoice.adminutama.show", $d);
        }
        else{
            $i = Checkout::where('kode_unik', $id)->first();
            ...
            return view("app.invoice.kasir.show", $d);
        }
    }
    ...
    public function print(){
        if(\Auth::user()->level == "AdminUtama"){
            ...
            return view('app.invoice.adminutama.print', $d);
        }
        else{
            $d['checkouts'] = Checkout::where("user_id", \Auth::user()->id)->orderBy("id", "DESC")->get();
            $d['informasiTokos'] = InformasiToko::first();

            return view('app.invoice.kasir.print', $d);
        }
    }
}

...
<section class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        <!-- [ breadcrumb ] end -->
        <!-- [ Main Content ] start -->
        <form method="POST" action="{{ route('semuaProduk.store') }}" enctype="multipart/form-data">
        @csrf
            <div class="row">
            <!-- [ file-upload ] start -->
                <div class="col-lg-4">
                    ...
                    <div class="card-body"> 
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input input onkeypress="return isNumberKey(event)" type="text" class="form-control" id="stok" name="stok" placeholder="Masukan Stok">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input input onkeypress="return isNumberKey(event)" type="text" class="form-control" id="harga_beli" name="harga_beli" placeholder="Masukan Harga Beli">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input input onkeypress="return isNumberKey(event)" type="text" class="form-control" id="diskon" name="diskon" placeholder="Masukan Diskon %">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="keterangan">Keterangan</label>
                                <textarea class="form-control" rows="2" name="keterangan" placeholder="Masukan keterangan"></textarea>
                            </div>
                        </div>
                        </div>

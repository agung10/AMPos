			...
			<div class="col-lg-4">
				<div class="card user-profile-list">
					<div class="card-header">
                        <center><h5>Tambah Kategori</h5></center>
                    </div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-12">
			...
			<div class="col-lg-8">
				<div class="card user-profile-list">
                    <div class="card-header">
						...
						<a href="{{ route('printKategoriProduks') }}" class="btn btn-primary btn-sm"><i class="feather icon-printer"></i> Cetak </a>
                    </div>
					<div class="card-body">
										...
										<tr>
											...
											<td>
												...
												<div class="overlay-edit">
													<a href="#"__kategori="{{ $res->kategori }}" __action="{{ route('kategoriProduk.update', $res->id) }}" class="btn btn-icon btn-warning edit"><i class="feather icon-edit"></i></a>
													<a href="#" data-uri="{{ route('kategoriProduk.destroy', $res->id) }}" class="btn btn-icon btn-danger" data-toggle="modal" data-target="#modalDestroy"><i class="feather icon-trash-2"></i></a>
												</div>
											</td>
										</tr>
									@endforeach
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label for="kategori">Kategori</label>
								<input type="text" class="form-control" id="kategoriInputEdit" name="kategori" placeholder="Masukan Kategori">
							</div>
						</div>
					</div>
				</div>

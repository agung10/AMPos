...
$(document).ready(function() {
    ...
    // [ With Placeholder ]
    $(".js-example-placeholder-multiple-k").select2({
        placeholder: "Pilih Kategori"
    });
    $(".js-example-placeholder-multiple-c").select2({
        placeholder: "Pilih Currency"
    });
    $(".js-example-placeholder-multiple-u").select2({
        placeholder: "Pilih Unit"
    });
    $(".js-example-placeholder-multiple-h").select2({
        placeholder: "Pilih Persentase Laba"
    });
    $(".js-example-placeholder-multiple-s").select2({
        placeholder: "Pilih Stok Min - PPN"
    });
    $(".js-example-placeholder-multiple-p").select2({
